...
public class MainView implements StackableView {
    ...
    private void InflateCurrentView() {
        if (currentState == STATE_INI) {
            ...
            Pager pager = new Pager(comicSrc);
            ...
            View pagerView = pager.InflateView(context);
            pagerView.setLayoutParams(new LinearLayout.LayoutParams(
                    ViewGroup.LayoutParams.MATCH_PARENT,
                    ViewGroup.LayoutParams.MATCH_PARENT
            ));

            grid_parent.addView(pagerView);
            //到此
